...
<body>
    ...
    >
        <section class="w-[20%] h-[100vh] bg-blue-600 text-white flex flex-col justify-between items-center">
            ...
            >
                <h1>
                    <a href="{{ route("user-dash") }}" class="text-[30px]">LOGO</a>
                </h1>                
            </div>
            <div 
            ...
            >
                <ul class="flex flex-col items-center w-[100%] ">
                    <a href="{{ route("user-dash") }}"  class="flex items-center hover:bg-black rounded-2xl w-[100%] pl-[25px] cursor-pointer">
                        ...
                        <p class="text-[20px] ml-[10px]">Dashboard</p>
                    </a>
                    ...
                    <a href="{{ route('create-user-dash') }}" class="flex items-center hover:bg-black rounded-2xl w-[100%] pl-[25px] cursor-pointer">
                        ...
                        <p class="text-[20px] ml-[10px]">New Post</p>
                    </a>
                    <a href="#" class="flex items-center hover:bg-black rounded-2xl w-[100%] pl-[25px] cursor-pointer">
                        ...
                        <p class="text-[20px] ml-[10px]">Orders</p>
                    </a>
                </ul>
                <ul>
                    <a href="{{ route('user-setting') }}" class="flex items-center hover:bg-black rounded-2xl w-[100%] pl-[25px] cursor-pointer">
                        ...
                        <p class="text-[20px] ml-[10px]">Setting</p>
                    </a>
                    <a href="{{ route('dashborad.logout') }}" class="flex items-center hover:bg-black rounded-2xl w-[100%] pl-[25px] cursor-pointer mb-[5px]">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 h-[60px]">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 9V5.25A2.25 2.25 0 0 1 10.5 3h6a2.25 2.25 0 0 1 2.25 2.25v13.5A2.25 2.25 0 0 1 16.5 21h-6a2.25 2.25 0 0 1-2.25-2.25V15m-3 0-3-3m0 0 3-3m-3 3H15" />
                        </svg>
                        <p class="text-[20px] ml-[10px]">Log Out</p>
                    </a>
                </ul>
